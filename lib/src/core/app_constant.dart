...
class KeyUtil {
  ...
  static Color primaryColor1 = "#d2fcd9".toColor();
  static Color bgColor1 = "#8ff772".toColor();
  ...
  static Color primaryColor2 = "#d2ddfa".toColor();
  static Color bgColor2 = "#5581fa".toColor();
  static Color primaryColor3 = "#d9cffc".toColor();
  static Color bgColor3 = "#6f4af7".toColor();
  ...
  static List<Dashboard> dashboardItems = [
    Dashboard(
        ...
        subtitle: "Learn New Math Tricks with Simple Games",
    ...
    Dashboard(
        ...
        gridColor: bgColor2,
        subtitle:
            "Commit Numbers and Symbols to Memory for Accurate Calculations",
    ...
    Dashboard(
        ...
        subtitle: "Improve Problem-Solving and Reasoning",
